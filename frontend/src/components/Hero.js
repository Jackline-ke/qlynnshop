...
const Hero = () => {
  return (
    <div id='hero' className='mb-18 home w-full h-full flex items-center justify-center lg:mb-6 bg-gradient-to-b from-gray-300 to-white lg:to-gray-100/50'>
      <div className='mt-24 w-full h-full lg:h-screen lg:mt-0 text-gray-800 flex flex-col lg:flex-row justify-center items-center px-8 md:px-16 lg:px-32 '>
        <div className='w-full h-96 lg:h-full flex justify-center lg:mt-32'>
          <img src="https://res.cloudinary.com/dmpr1moai/image/upload/v1706595060/qlynnshop/hero_fnuxzq.png" className='h-full object-cover' alt='hero'/>
        </div>
